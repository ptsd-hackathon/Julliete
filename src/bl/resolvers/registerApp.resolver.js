...
function registerApp(root, _a) {
    var appName = _a.appName;
    return __awaiter(this, void 0, void 0, function () {
        var appsRepository, foundAppDB, e_1, app, appDBPromise, e_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, appsRepository.findByName(appName)];
                case 2:
                    foundAppDB = _b.sent();
                    if (foundAppDB) {
                ...
                case 5:
                    _b.trys.push([5, 7, , 8]);
                    return [4 /*yield*/, appsRepository.save(app)];
                case 6:
                    appDBPromise = _b.sent();
                    console.log("new App saved with id " + appDBPromise.id);
                    return [2 /*return*/, { token: appDBPromise.id }];
                case 7:
                    e_2 = _b.sent();
                    console.log("error creating app " + e_2);
                    throw e_2;
...
//# sourceMappingURL=registerApp.resolver.js.map