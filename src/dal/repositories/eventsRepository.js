...
var EventsRepository = /** @class */ (function () {
    ...
    EventsRepository.prototype.save = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new event_1.Event(event).save()];
            });
        });
    };
    EventsRepository.prototype.findAllByUserAndAppTokenAndBetweenDates = function (userEmail, appToken, fromDate, toDate) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, event_1.Event.find({
